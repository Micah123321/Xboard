...
| 模块名 | 说明 | 最近更新 |
|--------|------|----------|
| [admin-frontend](admin-frontend.md) | 管理端前端登录、布局、仪表盘、用户管理、节点管理与管理 API 封装 | 2026-05-21 |
...
| [node-auto-online](node-auto-online.md) | 节点自动上线、运行缓存父入口兜底、重连冷却、父子显隐独立和管理端配置入口 | 2026-06-13 |
